...
I was working on the [projects](/projects) portion of this site that I forked from [ibelick](https://github.com/ibelick/hello) and I thought that I could extract the array of project objects into a little lib file `projects.ts`, create a component and add that component directly into MDX:
